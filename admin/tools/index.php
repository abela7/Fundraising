                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card h-100 border-info">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text text-muted small">Wipe the current database and restore it from an exported `.sql` backup file. Use this on your target machine (e.g., LOCAL).</p>
