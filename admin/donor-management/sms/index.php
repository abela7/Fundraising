                    ...
                    <div class="col-12 col-lg-4">
                        <div class="action-card h-100">
                            ...
                            <div class="action-list">
                                ...
                                <a href="../../messaging/whatsapp/templates.php" class="action-item" style="background: linear-gradient(135deg, rgba(37, 211, 102, 0.1), rgba(18, 140, 126, 0.1)); border-radius: 8px;">
                                    <div class="action-icon" style="background: #25D366; color: white;">
                                        <i class="fab fa-whatsapp"></i>
                                    </div>
                                    <div class="action-content">
                                        <p class="action-name">WhatsApp Templates</p>
