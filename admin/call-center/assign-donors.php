...
// ============================================
// STEP 1: Load ALL dependencies FIRST
// ============================================
...
// ============================================
// STEP 3: Initialize variables with defaults
// ============================================
...
// Initialize filter variables FIRST (before any conditionals)
...
// ============================================
// STEP 4: Database queries (with error handling)
// ============================================
try {
    $db = db();
    ...
    error_log("Assign Donors Error: " . $e->getMessage());
}

// ============================================
// STEP 5: NOW include sidebar/topbar (db() is available)
// ============================================
?>
<!DOCTYPE html>
<html lang="en">
